const VocaComponent=()=> {
    return (
        <>
        <div className="row g-0 border rounded-3xl overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style={{ backgroundColor: '#F4F1EC', color: '#000000'}}>
